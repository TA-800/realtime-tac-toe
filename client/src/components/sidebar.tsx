...
export default function Navbar() {
    return (
        <div className="bg-zinc-900 flex gap-2 sm:p-2 p-1 rounded-md border-2 border-white/20">
            {/* Home icon */}
            <Link to="/" className="transition-all rounded sm:p-2 p-1 hover:bg-white/10">
            ...
            {/* About icon */}
            <Link to="/about" className="transition rounded sm:p-2 p-1 hover:bg-white/10">
                <svg width="42" height="42" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path
