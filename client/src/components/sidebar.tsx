...
export default function Navbar() {
    return (
        <nav className="bg-zinc-900 flex gap-2 sm:p-2 p-1 rounded-md border-2 border-white/20">
            {/* Home icon */}
            <NavLink
                to="/"
                className={({ isActive }) => (isActive ? "bg-gray-700" : "hover:bg-gray-800") + " sm:p-2 p-1 rounded"}>
